...
<body>
      <div class="contents-right">
        ...
        <div class="glamping-N47" data-bid="iTlmG5UP9e" id="mypageApp">
            ...
            <div class="form-wrap">
              ...
              <div class="contents-form-group">
                <div class="inputset inputset-round">
                  <input type="text" class="inputset-input form-control" v-model="userId" readonly="" name="userId">
                </div>
              </div>
            </div>
            <div class="form-wrap">
...
<script>
  let mypageApp=Vue.createApp({
	  ...
	  methods:{
		  submitForm(e){
			if(this.userPwd && this.gender && this.userPwd1
