...
<body>
  <!-- [E]hooms-N54 -->
  <main class="th-layout-main" id="studyRoomAsk">
    <!-- [S]hooms-N2 -->
    ...
    <div class="hooms-N39" data-bid="fMlskcJMaO" id="studyRoom-ask">
      <div class="contents-inner">
       ...
       <form method="post" action="../studyRoom/ask_insert_ok.do" enctype="multipart/form-data">
          <div class="contents-form">
            <div class="contents-form-top">
              ...
              <div class="contents-radioset">
                <div class="radioset">
                  <input id="radioset-a-1-1" name="cate" class="radioset-input input-line" type="radio" value="시설 문의" checked="">
                  <label class="radioset-label" for="radioset-a-1-1"></label>
                  <span class="radioset-text">시설 문의</span>
                </div>
                <div class="radioset">
                  <input id="radioset-a-1-2" name="cate" class="radioset-input input-line" type="radio" value="가격 문의">
                  <label class="radioset-label" for="radioset-a-1-2"></label>
                  <span class="radioset-text">가격 문의</span>
                </div>
                <div class="radioset">
                  <input id="radioset-a-1-3" name="cate" class="radioset-input input-line" type="radio" value="취소 문의">
                  <label class="radioset-label" for="radioset-a-1-3"></label>
                  <span class="radioset-text">취소 문의</span>
                </div>
                <div class="radioset">
                  <input id="radioset-a-1-4" name="cate" class="radioset-input input-line" type="radio" value="기타 문의">
            ...
            <div class="contents-form-middle">
              <div class="inputset inputset-lg inputset-label">
                <label>
                  ...
                  <input type="text" class="inputset-input form-control" placeholder="성함을 입력해주세요." name="name" required="">
                </label>
              </div>
              <div class="inputset inputset-lg inputset-label">
                <label>
                  ...
                  <input type="text" class="inputset-input form-control" placeholder="제목을 입력해주세요." name="subject" required="">
                </label>
              </div>
              <div class="inputset inputset-lg inputset-label">
                 <label>
                ...
                <label>
                  ...
                  <input type="text" class="inputset-input form-control" placeholder="이메일을 입력해주세요." name="email" required="">
                </label>
              </div>
              <div class="inputset inputset-lg inputset-label">
                <label>
                  ...
                  <textarea class="inputset-textarea" placeholder="문의 내용을 입력해주세요." name="content" required=""></textarea>
            ...
            <div class="contents-sign">
             <!--  <button class="btnset modalset-btn">등록하기</button> -->
              <input type="submit" value="등록하기" class="btnset modalset-btn">
            </div>
          </div>
          </form>
        </div>
